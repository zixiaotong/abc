...
import com.abc.cutout.baiduseg.BodySeg;
...
public class AlphaApi {
    ...
    // alpha通道
    private final String alpha = "/segment/alpha";
...
//    }
    ...
    // alpha
    public Boolean alpha(String imageFileName) {
...
//            File file = new File("https://tp1-oapi.aisegment.com/20200403/matting/9f2/9f2f3fc196e34138a3e1f16de146e3bf.png");
            File file = new File("/Users/shanglei/Downloads/33.png");
            byte[] buffer = resizeAndReadImage(file);
            BodySeg.GenerateImage(base64(buffer), "/Users/shanglei/Downloads/ali2.jpeg");
            return true;
        } catch (Exception e) {
            System.out.println("Exception:" + e.getMessage());
            e.printStackTrace();
    ...
    public static void main(String[] args) {
        ...
        // 人像分割接口函数调用
//         api.imageSeg("/Users/ken/Desktop/1.jpg");

        // 头像分割接口函数调用
        // api.headSeg("/Users/ken/Desktop/1.jpg");

        api.alpha("/Users/shanglei/Downloads/1.jpeg");

        // 证件照制作接口函数调用
//        api.idPhotoMake("/Users/shanglei/Downloads/1.jpeg", // 原图
//                "1", // 规格ID，可以通过使用文档找到期望的ID
//                null, // 背景颜色
//                "/Users/shanglei/Downloads/ali2.jpeg" // 证件照结果图
//        );
